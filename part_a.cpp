...
////    str = replace(str, "\\x00", "\\0");
////    str = replace(str, "\\x07", "\\a");
////    str = replace(str, "\\x08", "\\b");
////    str = replace(str, "\\x09", "\\t");
////    str = replace(str, "\\x10", "\\n");
////    str = replace(str, "\\x11", "\\v");
////    str = replace(str, "\\x12", "\\f");
////    str = replace(str, "\\x13", "\\r");
//
//    str = replace(str, "\\x00", "\\0");
//    str = replace(str, "\\x07", "\\a");
//    str = replace(str, "\\x08", "\\b");
//    str = replace(str, "\\x09", "\\t");
//    str = replace(str, "\\x0A", "\\n");
//    str = replace(str, "\\x0B", "\\v");
//    str = replace(str, "\\x0C", "\\f");
//    str = replace(str, "\\x0D", "\\r");
//
//    str = replace(str, "\\x20", " ");
//    str = replace(str, "\\x21", "!");
//    str = replace(str, "\\x22", "\"");
...
//                }
//            }
//            else if (str[i + 1] != 'n' &&  str[i + 1] != 't' && str[i + 1] != 'r' && str[i + 1] != '0' &&
//                     str[i + 1] != '\"' && str[i + 1] != '\\' ){
...
//
//    for(int i = 0; i < new_string_2.size(); i++) {
//        std::cout << "i is: " << i << " and the char is:" << new_string_2.substr(i, 1) << std::endl;
//
//
...
////    new_string_2 = replace(new_string_2, "\\n", "\\\n");
////    new_string_2 = replace(new_string_2, "\\t", "\\\t");
////    new_string_2 = replace(new_string_2, "\\r", "\\\r");
////    new_string_2 = replace(new_string_2, "\\\"", "\"");
//
//
//    }
